...
class Action {
    ...
    Action (int stockWater, int stockMilk, int stockBeans, int stockCups, int stockMoney) {
    ...
    static void buy() {
        ...
        switch (product) {
            case "1":
                if (stockWater >= Products.ESPRESSO.water && stockBeans >= Products.ESPRESSO.beans && stockCups >= Products.ESPRESSO.cups) {
